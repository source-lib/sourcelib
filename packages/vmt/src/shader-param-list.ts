...
export default {
    shaderParams: [
        ...
        },
        {
            "name": "$alphatest",
            "type": "bool",
            "description": "Enables binary transparency. The alpha values is rounded to 0 or 1 depending on `$alphatestreference`.",
            "defaultCompletion": 1,
            "wikiUri": "https://developer.valvesoftware.com/wiki/$alphatest"
        },
        {
            "name": "$alphatestreference",
            "type": "scalar",
            "description": "Specifies the minimum color value of the alpha channel in which the effect is rounded to 255. A value of `.3` will create a thicker shape while a value of `.7` will create a thinner shape.",
            "defaultCompletion": 0.5,
            "wikiUri": "https://developer.valvesoftware.com/wiki/$alphatest"
        },
        {
            "name": "$allowalphatocoverage",
            "type": "bool",
            "description": "**Requires MSAA.** Creates transparent steps based on alpha values. Can be used for softer edges. This parameter is incompatible with `$alphatestreference`.",
            "defaultCompletion": 1,
            "wikiUri": "https://developer.valvesoftware.com/wiki/$alphatest"
        },
        {
