...
test("Tokenize Simple KV", () => {
    const tkn = new tokenizer_1.Tokenizer();
    tkn.tokenizeFile(`"File"
        {
            "Keyvalues" {
    ...
    expect(tokens[0].type).toBe(token_1.TokenType.Key);
    ...
    expect(tokens[5].type).toBe(token_1.TokenType.Key);
    expect(tokens[6].value).toBe("\"a a\"");
    expect(tokens[6].line).toBe(6);
    expect(tokens[6].type).toBe(token_1.TokenType.Value);
    expect(tokens[7].value).toBe("// Comment after the line");
    expect(tokens[7].line).toBe(6);
    expect(tokens[50].type).toBe(token_1.TokenType.Value);
...
test("Tokenize preprocessor", () => {
    ...
    expect(tokens[0].type).toBe(token_1.TokenType.Comment);
    expect(tokens[1].type).toBe(token_1.TokenType.PreprocessorKey);
    expect(tokens[2].type).toBe(token_1.TokenType.Value);
    expect(tokens[3].type).toBe(token_1.TokenType.Key);
    expect(tokens[4].type).toBe(token_1.TokenType.ObjectStart);
    expect(tokens[5].type).toBe(token_1.TokenType.PreprocessorKey);
    expect(tokens[6].type).toBe(token_1.TokenType.Value);
    expect(tokens[7].type).toBe(token_1.TokenType.Key);
    expect(tokens[8].type).toBe(token_1.TokenType.Value);
    expect(tokens[9].type).toBe(token_1.TokenType.ObjectEnd);
});
test("Tokenize missing closing quote on string", () => {
    ...
    expect(tokens[2].type).toBe(token_1.TokenType.Key);
    expect(tokens[2].value).toBe("\"key1\"");
    expect(tokens[3].type).toBe(token_1.TokenType.Value);
    expect(tokens[3].value).toBe("value1");
    expect(tokens[4].type).toBe(token_1.TokenType.Key);
    expect(tokens[4].value).toBe("\"key2\"");
    expect(tokens[5].type).toBe(token_1.TokenType.Value);
    expect(tokens[5].value).toBe("\"value2");
    expect(tokens[6].type).toBe(token_1.TokenType.Key);
    expect(tokens[6].value).toBe("\"key3\"");
    expect(tokens[7].type).toBe(token_1.TokenType.Value);
    expect(tokens[7].value).toBe("value3\"");
    expect(tokens[8].type).toBe(token_1.TokenType.Key);
    expect(tokens[8].value).toBe("\"key4 value4");
    expect(tokens[9].type).toBe(token_1.TokenType.Key);
    expect(tokens[9].value).toBe("key5");
    expect(tokens[10].type).toBe(token_1.TokenType.Value);
...
test("Tokenize multiple values", () => {
    ...
    expect(tokens[0].type).toBe(token_1.TokenType.Key);
    expect(tokens[1].type).toBe(token_1.TokenType.ObjectStart);
    expect(tokens[2].type).toBe(token_1.TokenType.Key);
    expect(tokens[3].type).toBe(token_1.TokenType.Value);
    expect(tokens[3].value).toBe("\"v1\"");
    expect(tokens[4].type).toBe(token_1.TokenType.Value);
...
test("Tokenize conditionals", () => {
    ...
    expect(tokens[2].type).toBe(token_1.TokenType.Key);
    expect(tokens[3].type).toBe(token_1.TokenType.Value);
    expect(tokens[4].type).toBe(token_1.TokenType.Conditional);
    expect(tokens[4].value).toBe("[$TEST]");
    expect(tokens[5].type).toBe(token_1.TokenType.Key);
    expect(tokens[5].value).toBe("\"k2\"");
    expect(tokens[6].type).toBe(token_1.TokenType.Value);
    expect(tokens[7].type).toBe(token_1.TokenType.Conditional);
