...
test("Color Matches Valid 0-255", () => {
    const desc = (0, color_1.getColorMatches)("{0 255 10}");
    expect(desc.validFormat).toBe(true);
    expect(desc.r).toBe(0);
    expect(desc.g).toBe(255);
    expect(desc.b).toBe(10);
    expect(desc.a).toBe(1);
    expect(desc.parenthesisType).toBe(color_1.ColorMatchParenthesisType.Braces);
});
test("Color Matches Valid 0-1", () => {
    const desc = (0, color_1.getColorMatches)("[0 1 0.1]");
    expect(desc.validFormat).toBe(true);
    expect(desc.r).toBe(0);
    expect(desc.g).toBe(255);
    expect(desc.b).toBe(25.5);
    expect(desc.a).toBe(1);
    expect(desc.parenthesisType).toBe(color_1.ColorMatchParenthesisType.Brackets);
});
test("Color Matches Invalid", () => {
    const desc = (0, color_1.getColorMatches)("hi");
    expect(desc.validFormat).toBe(false);
});
test("Color Matches Oob 0-255", () => {
    const desc = (0, color_1.getColorMatches)("{270 0 1}");
    expect(desc.validFormat).toBe(true);
    expect(desc.valuesOutOfBounds).toBe(true);
    expect(desc.parenthesisType).toBe(color_1.ColorMatchParenthesisType.Braces);
});
test("Color Matches Oob 0-1", () => {
    const desc = (0, color_1.getColorMatches)("[0 0 3]");
    expect(desc.validFormat).toBe(true);
    expect(desc.valuesOutOfBounds).toBe(true);
    expect(desc.parenthesisType).toBe(color_1.ColorMatchParenthesisType.Brackets);
});
