import { ShaderParam } from "./VmtParam.js";
...
export const shaderParams = [
    ...
    },
    {
        ...
        defaultCompletion: 1,
        description:
            "*[Compiled]* Skip compiling lightmaps for this material. Useful for solid black or self-illuminating materials.",
    ...
    },
    {
        ...
        defaultCompletion: 1,
        description:
            "*[Compiled]* Makes the brush an NPC clip. Only NPCs collide with this brush. (Note that Portal 2 security cameras and turrets are NPCs)",
    ...
    },
    {
        ...
        type: "texture",
        description:
            "The base color texture to use. Also called albedo/diffuse map. On water, this is used as a 'sludge layer'.",
    ...
    },
    {
        ...
        description:
            "Marks the material to be used as an overlay or decal. With this on, this material no longer seals the map and hammer properly displays it in the 3D viewport without Z-fighting",
    },
    {
        name: "$decalscale",
        type: "float",
    ...
    },
    {
        ...
        wikiUri: "https://developer.valvesoftware.com/wiki/Decals",
        description:
            "Scales the amount of fog affecting the decal. Usefog for making important decals stand lib in foggy levels.",
    },
    {
        name: "$decaltexture",
        type: "texture",
    ...
    },
    {
        ...
        description:
            "Defines the texture to represent reflections on this material. Use *env_cubemap* to use the nearest cubemap.",
    ...
    },
    {
        ...
        defaultCompletion: 1,
        description:
            "Makes the material always appear on top of everything else. Only really used for user-interfaces.",
    ...
    },
    {
        ...
        defaultCompletion: 1,
        description:
            "Marks the material to be used for models rather than brushes. Also hides it from Hammer's texture browser.",
    ...
    },
    {
        ...
        type: "texture",
        description:
            "Defines the normal map to use. Same as `$bumpmap`. \n\nThe [PBR](https://docs.momentum-mod.org/guide/pbr-shader/) shader uses the alpha channel as a height map for parallax occlusion mapping.",
        wikiUri: "https://developer.valvesoftware.com/wiki/Bump_map",
    },
    {
        name: "$notint",
    ...
    },
    {
        ...
        type: "string",
        description:
            "Sets the physical surface properties to use for this material. This affects sounds and physics like mass and buoyancy.",
    ...
    },
    {
        ...
        defaultCompletion: 1,
        description:
            "Enables the tree-sway effect, which morphs the material according to the level's env_wind to emulate wind blowing through leaves.",
    ...
    },
    {
        ...
        type: "texture",
        description:
            "Used in the PBR shader to represent **M**etallic, **R**oughness and **A**mbient **O**cclusion maps. \n\nRed: Metallic \n\nGreen: Roughness \n\nBlue: Ambient Occlusion",
    ...
    },
    {
        ...
        defaultCompletion: 0,
        description:
            "Amount of units from the camera that the fog starts. **Warning: Must be 0 for edge fading to work properly.**",
        wikiUri: "https://developer.valvesoftware.com/wiki/Water_(shader)",
    },
    {
        name: "$fogend",
    ...
    },
    {
        ...
        defaultCompletion: 1,
        description:
            "Make the water reflect the 3D skybox in addition to other reflections. **Requires a `sky_camera` in the map.**",
        wikiUri: "https://developer.valvesoftware.com/wiki/Water_(shader)#Reflection",
    },
    {
    ...
    },
    {
        ...
        defaultCompletion: 0,
        description:
            "Replaces the water surface with a literal rendering of the flow map. Don't rely on Hammer's view for alignment.",
        wikiUri: "https://developer.valvesoftware.com/wiki/Water_(shader)#Flowing_water",
    },
    {
        name: "$selfillum",
        ...
        defaultCompletion: 1,
        description:
            "Self illumination applies 'fake' light to a surface, regardless of the true light that the surface receives from the environment.",
    ...
    },
    {
        ...
        description:
            "Defines the intensity of the effect, on a scale of 0-1; the higher the number the greater the intensity. '0.1' is a good starting point, but you may need to increase/decrease it to get the desired effect. Values to the hundredths place are accepted.",
        wikiUri: "https://wiki.stratasource.org/material/pbr/parallaxmapping",
    },
    {
